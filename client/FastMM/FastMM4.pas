...
{$ifdef EnableMemoryLeakReporting}
  ...
  {$endif}
      ...
      begin
        ...
        //--add by shajp:----------------2011.11.24
        LMsgPtr := AppendStringToBuffer('¹²', LMsgPtr, Length('¹²'));
        LMsgPtr := CardinalToStrBuf(LNumMediumAndLargeLeaks , LMsgPtr);
        LMsgPtr := AppendStringToBuffer('¸ö:'+#13#10, LMsgPtr, Length('¸ö:'+#13#10));
        //===============================
        {List all the blocks}
