...
type
  TfrmQueryAudioList = class(TQueryPictureListFrm)
    procedure FormClose(Sender: TObject; var Action: TCloseAction);
  private
    { Private declarations }
  public
    { Public declarations }
    procedure OnAudioDataUpload(dev: TDevice; mediaData: TMediaDataUpload_V3);
  end;
...
procedure TfrmQueryAudioList.OnAudioDataUpload(dev: TDevice;
...
procedure TfrmQueryAudioList.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Mainf.show_QueryAudioList.Checked := False;
end;
