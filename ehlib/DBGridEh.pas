...
{$ENDIF}
  ...
  protected
    ...
    procedure SetKeyValue(Value: Boolean); virtual;
...
{$ENDIF}
  ...
  public
    ...
    property KeyValue: Boolean read FkeyValue write SetKeyValue default False;
...
{$ENDIF}
  ...
  public
    // liusen
    FKeyValueList: TStringList; // 将keyvalue的值添加到该容器中
...
begin
  ...
  begin
    ...
    try
      ...
      KeyValue := TColumnEh(Source).KeyValue;
...
procedure TColumnEh.SetKeyValue(Value: Boolean);
begin
...
var
  ...
  // liusen
  //oldKeyVaule, newKeyValue: string;
...
//      InflateRect(DHRect, 1, 1);
  ...
  function checkKeyValues(): Boolean;
  var
  ...
  begin
    ...
    prActiveRecord := FDataLink.ActiveRecord - 1;
      ...
      begin // Draw contents
        ...
        begin
          ...
          begin
            ...
            if DrawColumn.HideDuplicates and
               CheckColumnDuplicateValues(DrawColumn, FColCellParamsEh.FText) and checkKeyValues then
            begin
              FColCellParamsEh.FText := '';
              FColCellParamsEh.FImageIndex := -1;
              ClearSubLine := True;
